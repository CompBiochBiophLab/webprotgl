...
CREATE TABLE IF NOT EXISTS Users (rid INTEGER NOT NULL, first_name TEXT NOT NULL,
  last_name TEXT NOT NULL, email TEXT NOT NULL, password BLOB NOT NULL, salt BLOB NOT NULL,
